...
**Misión:** resolver volumen bien especificado, rápido y sin salirse de la línea.

**Puede:** codificar tareas S `normal` (componentes aislados, CRUD, fixtures, tests unitarios, documentación, refactors mecánicos), pre-revisar y depurar (reproducir bugs y escribir el test que falla).
...
**Escala:** cualquier decisión de diseño y cualquier duda de seguridad.

**Salida:** reporte o pre-revisión según las plantillas, y máximo 3 líneas al PO.
